...
const WhatsAppFloating = () => (
  <>
    <a
      ...
      className="cta-attention fixed bottom-6 left-4 md:left-6 z-40 hidden sm:inline-flex items-center gap-2 rounded-full bg-card border border-border shadow-elevated px-5 py-3 text-sm font-semibold text-foreground hover:text-primary hover:-translate-y-1 transition-all"
    >
    ...
    <a
      ...
      className="cta-attention cta-attention-whatsapp group fixed bottom-5 right-4 md:bottom-6 md:right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl hover:scale-110 hover:bg-[#1ebe5a] transition-all duration-200"
    >
